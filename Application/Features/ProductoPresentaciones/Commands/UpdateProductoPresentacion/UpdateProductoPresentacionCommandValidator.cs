...
{
    public class UpdateProductoPresentacionCommandValidator : AbstractValidator<UpdateProductoPresentacionCommand>
    {
        public UpdateProductoPresentacionCommandValidator()
        {
            ...
            RuleFor(cmd => cmd.ProductoPresentacionId)
                .GreaterThan(0)
                .WithMessage("El ID del producto presentacion debe ser mayor que 0.");
